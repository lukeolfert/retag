package com.example.luke.retag;
...
public class FasterAnimationsContainer{
    ...
    public static synchronized FasterAnimationsContainer getInstance(ImageView imageView) {
        if (sInstance == null)
        ...
        public void run() {
            ...
            if (imageView.isShown()) {
                ...
                if(mIndex == 1) {
                    ...
                    synchronized (FramesSequenceAnimation.this) {
